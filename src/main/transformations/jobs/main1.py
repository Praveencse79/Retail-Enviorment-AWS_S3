...
#if file is there then check if the some file is present in the staging area
...
# **** make csv lines convert into a list of comma separated essenes
...
#product table
logger. info("***************** Loading product table into product table df ***********************")
...
#Write the data into Customer Data Mart
...
#urite the data into MySQL table
...
#Calulation for sales team mart
...
#Calclutation for sales team mart
#Find out the total sales done by each sales person every month
#Give the top performer 1% incentive of total sales of the month
#Rest sales person will get nothing
#write the data into MySQL table |
